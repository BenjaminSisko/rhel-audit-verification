...
# Start here — RHEL Audit Verification 1.4.6
...
2. In Splunk Web: **Apps → Manage Apps → Install app from file**. Select
   **dist/TA_au2_linux-1.4.6.spl**. Back up an older app and site lookups before
...
- dist/TA_au2_linux-1.4.6.spl: install this in Splunk, not on the forwarder.
